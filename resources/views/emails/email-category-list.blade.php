    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900">Email categories</h1>
            </div>
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                <button type="button" id="createBtn" class="block rounded-md bg-pipexblue px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add email category</button>
            </div>
        </div>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                <tr>
                                    ...
                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-sm font-medium sm:pr-6">
                                        <a href="{{ route('delete-category', $category->id) }}" class="text-red-600 hover:text-red-900">Delete<span class="sr-only">, {{ $category->category_name }}</span></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                    ...
                    <form action="{{ route('add-category') }}" method="post">
                        ...
                        <div>
                            <div class="mt-3 sm:mt-5">
                                <h3 class="text-base text-center font-semibold leading-6 text-gray-900" id="modal-title">Create email category</h3>
                                <div class="mt-2">
