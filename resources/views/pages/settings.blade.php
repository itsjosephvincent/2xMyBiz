...
@section('title', 'Settings - 2xMyLeads')
            ...
            <div class="border border-gray-200 bg-white px-2 py-5 sm:px-6 mt-4">
                <nav class="flex flex-1 flex-col" aria-label="Sidebar">
                    <ul role="list" class="-mx-2 space-y-1">
                        <li>
                            <a href="{{ route('business-information') }}" class="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 pl-3 text-sm leading-6 font-semibold">Business info</a>
                        </li>
                        <li>
                            <a href="{{ route('business-logo') }}" class="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 pl-3 text-sm leading-6 font-semibold">Business logo</a>
                        </li>
                        <li>
                            <a href="{{ route('business-banner') }}" class="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 pl-3 text-sm leading-6 font-semibold">Business banner</a>
                        </li>
                        <li>
                            <a href="{{ route('business-calender') }}" class="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 pl-3 text-sm leading-6 font-semibold">Calendar</a>
                        </li>
                        <li>
                            <div>
                                <button type="button" class="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 pl-3 text-sm leading-6 font-semibold affiliate-drop-down flex items-center w-full text-left" aria-controls="sub-menu-1" aria-expanded="false">
                                    Affiliate Marketing
                                ...
                                <ul class="hidden mt-1 px-2" id="affiliate-menu">
                                    <li>
                                        <a href="{{ route('myleads') }}" class="hover:text-indigo-600 hover:bg-gray-50 block rounded-md py-2 pr-2 pl-9 text-sm font-medium leading-6 text-gray-700">2xMyLeads</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('kartra') }}" class="hover:text-indigo-600 hover:bg-gray-50 block rounded-md py-2 pr-2 pl-9 text-sm font-medium leading-6 text-gray-700">Kartra</a>
                                    </li>
                                    @foreach ($affiliates as $affiliate)
                                    <li>
                                        <a href="{{ route('affiliate', $affiliate->id) }}" class="hover:text-indigo-600 hover:bg-gray-50 block rounded-md py-2 pr-2 pl-9 text-sm font-medium leading-6 text-gray-700">{{ $affiliate->name }}</a>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
